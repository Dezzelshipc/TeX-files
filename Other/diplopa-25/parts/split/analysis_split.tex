...
Найдём значения точки равновесия. Используем обозначения \eqref{flow_sub} и \(\alpha'_0 = \alpha^b_s\). Рассмотрим цепь, не включая связь третьего уравнения в \eqref{double_stab_system}.
\begin{itemize}
    \item \( i = 2p \leq s\). Тогда \( N_{2p} = g_{2p-1} N_{2p-2} - \mu_{2p-1} = \dots = H_{2p-1} (N_0 - f_{2p-1}) \);
    \item \( i = 2p - 1\leq s \). \(N_{2p-1} = H_{2p-2} (N_1 - f_{2p-2}) \);
    \item \( i > s, ~ i \equiv s \mod 2 \). \( N_{2p} = \frac{H_{2p-1}}{H_{s-1}} \left( N_s - \frac{\mu_{s+1}}{g_{s+1}} - \dots - \frac{\mu_{2p-1}}{g_{s+1} \cdots g_{2p-1}} \right) = \) \\
    \( = \frac{H_{2p-1}}{H_{s-1}} \left( N_s - H_{s-1} (f_{2p-1} - f_{s-1}) \right) \);
    \item \( i > s, ~ i \neq s \mod 2 \). \( N_{2p-1} = \frac{H_{2p-2}}{H_{s}} \left( N_{s+1} - H_{s} (f_{2p-2} - f_{s}) \right) \);
    \item \( k = 2l \). \( N'_{2l} = H'_{2l-1} (N_s - f'_{2l-1}) \);
    \item \( k = 2l - 1\). \(N'_{2l-1} = H'_{2l-2} (N'_1 - f'_{2l-2}) \);
    \item \(N_{q-1} = \frac{m_q}{k_q \alpha_{q-1}}\), \(N'_{r-1} = \frac{m'_r}{k'_r \alpha'_{r-1}}\);
\end{itemize}

\begin{equation*}
    N_0 = \frac{a_1 m_1}{\alpha_0} - \frac{Q}{\alpha_0 N_1}.
\end{equation*}

\begin{enumerate}
    \item Если \(q+1 \equiv s \mod 2\): \(N_{q+1} = \begin{cases}
        H_{2p} (N_1 - f_{2p}), & q = 2p, \\
        H_{2p-1} (N_0 - f_{2p-1}), & q = 2p-1.
    \end{cases}\)

    Тогда из условия \(N_{q+1} = 0\) следует \(\begin{cases}
        N_1 = f_{2p}, & q=2p, \\
        N_0 = f_{2p-1}, & q=2p-1.
    \end{cases}\).

    При \(q=2p\): \(\frac{a_1 m_1}{\alpha_0} < N_0 = \frac{a_1 m_1}{\alpha_0} - \frac{Q}{\alpha_0 f_{q}}\), откуда \(- \frac{Q}{\alpha_0 f_{q}} > 0\). То есть выполняется всегда.
    ...
    \begin{equation*}
        ...
        \end{split}
    \end{equation*}
    По условиям \(0 \leq a_i \leq 1\). Значит выражение выполняется почти всегда. Исключением является вырожденный случай при \(q = 1, ~ k_1 = 1\).
\end{enumerate}