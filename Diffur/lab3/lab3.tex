...
\begin{document}
    ...
    \fefutitlepage{ОТЧЁТ}{к лабораторной работе №3 по дисциплине\\ \textquote{Дифференциальные уравнения}}
    {01.03.02 \textquote{Прикладная математика и информатика}}{Б9121-01.03.02сп(1)}{Держапольский Ю.В.}
    ...
    \section{Задание 2}
        \subsection{Постановка задачи}
            ...
            Реализацию решения проводить на языке \textquote{C++}:
