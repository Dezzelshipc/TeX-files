\section{Задание 3: Генератор псевдо-случайных чисел}
    ...
    \subsection{Решение}
        ...
        caption=Код генератора псевдо-случайных чисел.,
        captionpos=t,
        style=colored,
        ...
        \lstinputlisting[language=Python,
        caption=Пример вызова генератора.,
        captionpos=t,
        style=colored,
        basicstyle=\footnotesize\dejavu,
        frame=lines]{source/task3_ex.py}